...
if(NOT DEFINED DOXYGEN_DOT_BATCH_SIZE)
    set(DOXYGEN_DOT_BATCH_SIZE 50)
endif()
...
if(NOT DEFINED DOXYGEN_MERMAID_RENDER_MODE)
    set(DOXYGEN_MERMAID_RENDER_MODE AUTO)
endif()
if(NOT DEFINED DOXYGEN_MERMAID_JS_URL)
    set(DOXYGEN_MERMAID_JS_URL https://cdn.jsdelivr.net/npm/mermaid@11/dist/mermaid.esm.min.mjs)
endif()
