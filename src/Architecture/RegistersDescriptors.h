...
#if defined(ARCH_ARM)
#include "Architecture/ARM/RegistersDescriptors.h"
USE_DESCRIPTORS(ARM);
#elif defined(ARCH_ARM64)
#include "Architecture/ARM64/RegistersDescriptors.h"
USE_DESCRIPTORS(ARM64);
#elif defined(ARCH_X86)
#include "Architecture/X86/RegistersDescriptors.h"
USE_DESCRIPTORS(X86);
#elif defined(ARCH_X86_64)
#include "Architecture/X86_64/RegistersDescriptors.h"
